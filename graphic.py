...
def load_images():
    ...
    for image in images:
        IMAGES[mapping[image]]=p.transform.scale(p.image.load("C:/Users/MTS/Downloads/chessengine/images/"+image+".png"),(SQ_SIZE,SQ_SIZE)) # Change this with your path
