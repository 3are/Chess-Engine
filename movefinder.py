...
# Author: Ahmed Alaa (@obia.ahmed1337)
# License: MIT

####################################################
import random
import numpy as np
## Storing chances as vars
CHECKMATE = 1000000
STALEMATE = 0
DEPTH = 4
# Setting legal moves
